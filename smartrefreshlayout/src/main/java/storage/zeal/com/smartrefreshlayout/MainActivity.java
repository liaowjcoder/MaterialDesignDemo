...
public class MainActivity extends AppCompatActivity implements SmartFreshLayout.RefreshListener {
    ...
    private SmartFreshLayout mSmartLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSmartLayout = (SmartFreshLayout) findViewById(R.id.smart_refresh_layout);
